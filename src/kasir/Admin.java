...
public class Admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Daftar Makanan"));
    ...
    private void data_harga(){
     try{
            ...
            String sql1 = "SELECT * FROM ms_food";
            st = con.createStatement();
            rs = st.executeQuery(sql1);
            while(rs.next()){
                DefaultTableModel model = (DefaultTableModel) tableharga.getModel();
                Object[] row = new Object[4];
                row[0] = rs.getString("id_food");
                row[1] = rs.getString("nm_food");
                row[2] = rs.getString("ktgry_food");
                row[3] = rs.getString("prc_food");                
                model.addRow(row);
            }
    ...
    private void simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanActionPerformed
         try{
            String pass = new String(password.getPassword());
            con = Koneksi.getKoneksi();
            String sql = "UPDATE ms_food set prc_food='"+harga.getText()+"' where id_food='"+bayangan1.getText()+"'";
            st = con.createStatement();
            st.execute(sql);
            JOptionPane.showMessageDialog(null,"Berhasil");
            DefaultTableModel model = (DefaultTableModel) tableharga.getModel();
